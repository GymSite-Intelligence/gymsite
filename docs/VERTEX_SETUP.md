...
2. Seletor de projeto no topo: **`gen-lang-client-0662901510`**
3. Clicar **Enable**

### 2. Criar Service Account

1. Abrir https://console.cloud.google.com/iam-admin/serviceaccounts
2. Confirmar projeto `gen-lang-client-0662901510`
...
1. Na lista de service accounts, clicar em `gymsite-pipeline@gen-lang-client-0662901510.iam.gserviceaccount.com`
2. Aba **Keys** → **Add Key** → **Create new key**
3. Tipo: **JSON** → **Create**
4. Arquivo baixa automático: tipo `gen-lang-client-0662901510-abc123.json`
...
GOOGLE_CLOUD_PROJECT=gen-lang-client-0662901510
...
Após migração, o Cloud Audit Logs do projeto `gen-lang-client-0662901510` mostra cada chamada Vertex feita pela SA `gymsite-pipeline`. Útil pra:
