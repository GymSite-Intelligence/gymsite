...
| **Gemini Search Grounding** (`GEMINI_API_KEY`) | runtime (API) | — | A3 (horários), A4 (aluguel mediana Tier 1) |
| **SearchAPI.io** (`SEARCHAPI_KEY`) | runtime (API) | — | A4 aluguel portais (Tier 1b, `aluguel_municipio_portais.py`), Popular Times (Tier 1) |
