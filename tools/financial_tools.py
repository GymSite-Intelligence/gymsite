...
def _resumo_decisao_a4(fin: dict) -> dict:
    ...
    """
    cenarios_raw = fin.get("cenarios")
    cenarios: dict = cenarios_raw if isinstance(cenarios_raw, dict) else {}
    ...
    c_raw = cenarios.get(_faixa_key_de_modelo(rec_modelo))
    c: dict = c_raw if isinstance(c_raw, dict) else {}
