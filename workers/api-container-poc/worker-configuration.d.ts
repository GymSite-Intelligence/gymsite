/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=api-container-poc/wrangler.jsonc api-container-poc/worker-configuration.d.ts` (hash: 129abdfd00789cc53af067b6bae530fc)
// Runtime types generated with workerd@1.20260801.1 2026-08-05 nodejs_compat
interface __BaseEnv_Env {
	GYMSITE_API: DurableObjectNamespace<import("./src/index").GymSiteApiContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GymSiteApiContainer";
	}
