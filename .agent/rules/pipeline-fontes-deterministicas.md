...
- **Auditoria Tools — `buscar_imoveis_texto`:** **Closed** Corrective `8095337` em prod (API+worker). Retest operacional = próximo relatório sem dual SKU. Ver [`auditoria-tools.md`](auditoria-tools.md).
