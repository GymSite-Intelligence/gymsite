...
2. **Número no relatório = tool ou banco**, nunca boca de LLM. A0 tem override CNPJ; A4 aluguel = MRLR; demografia = IBGE.
...
| Aluguel viabilidade | `aluguel_mrlr.py` |
...
| Quando | Ler |
|---|---|
| Novo agente ou macro no pipeline | `docs/arquitetura/PIPELINE_AGENTES.md` + este arquivo |
