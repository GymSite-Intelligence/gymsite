...
- **Auditoria Tools — `buscar_imoveis_texto`:** **Closed** Corrective `8095337` + Retest ledger `699371c7…` (só SearchAPI, sem Places). Ver [`auditoria-tools.md`](auditoria-tools.md).
