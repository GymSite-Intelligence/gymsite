/**
 * DropdownMenu — primitivo shadcn/ui sobre @radix-ui/react-dropdown-menu.
 *
 * Composição típica:
 *   <DropdownMenu>
 *     <DropdownMenuTrigger asChild>
 *       <Button>Org: Vectra</Button>
 *     </DropdownMenuTrigger>
 *     <DropdownMenuContent>
 *       <DropdownMenuLabel>Organizações</DropdownMenuLabel>
 *       <DropdownMenuSeparator />
 *       <DropdownMenuItem>Trocar org…</DropdownMenuItem>
 *       <DropdownMenuItem>Sair</DropdownMenuItem>
 *     </DropdownMenuContent>
 *   </DropdownMenu>
 *
 * Trazemos só os items mais usados; sub-menus / checkboxes / radio groups
...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'z-50 min-w-[10rem] overflow-hidden rounded-md border border-border bg-card p-1 text-foreground shadow-lg',
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      'px-2 py-1.5 text-[10px] uppercase tracking-wider font-mono text-muted-foreground',
      inset && 'pl-8',
      className,
    )}
    {...props}
