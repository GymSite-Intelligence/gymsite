...
-- Nota: Supabase/PostgreSQL não suporta CREATE TYPE IF NOT EXISTS para enums.
-- Se os types já existirem, essa migration falhará. Nesse caso, pule manualmente.

create type otimizacao_status as enum (
  'pendente', 'aprovada', 'rejeitada', 'implementada', 'cancelada'
);

create type otimizacao_tipo as enum (
  'MODELO_OVERPRICED',
  'FLASH_PARA_LITE',
  'AGENTE_VORAZ',
  'ERRO_REPETIDO',
